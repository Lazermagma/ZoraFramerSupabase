...
VALUES 
    ('f0000000-0000-0000-0000-000000000001'::UUID, 'b0000000-0000-0000-0000-000000000001'::UUID, 'd0000000-0000-0000-0000-000000000001'::UUID, NOW() - INTERVAL '2 days'),
    ('f0000000-0000-0000-0000-000000000002'::UUID, 'b0000000-0000-0000-0000-000000000001'::UUID, 'd0000000-0000-0000-0000-000000000002'::UUID, NOW() - INTERVAL '5 days'),
    ('f0000000-0000-0000-0000-000000000003'::UUID, 'b0000000-0000-0000-0000-000000000001'::UUID, 'd0000000-0000-0000-0000-000000000003'::UUID, NOW() - INTERVAL '1 day'),
    ('f0000000-0000-0000-0000-000000000004'::UUID, 'b0000000-0000-0000-0000-000000000002'::UUID, 'd0000000-0000-0000-0000-000000000003'::UUID, NOW() - INTERVAL '3 days'),
    ('f0000000-0000-0000-0000-000000000005'::UUID, 'b0000000-0000-0000-0000-000000000002'::UUID, 'd0000000-0000-0000-0000-000000000004'::UUID, NOW() - INTERVAL '7 days'),
    ('f0000000-0000-0000-0000-000000000006'::UUID, 'b0000000-0000-0000-0000-000000000003'::UUID, 'd0000000-0000-0000-0000-000000000004'::UUID, NOW() - INTERVAL '10 days'),
    ('f0000000-0000-0000-0000-000000000007'::UUID, 'b0000000-0000-0000-0000-000000000003'::UUID, 'd0000000-0000-0000-0000-000000000005'::UUID, NOW() - INTERVAL '4 days')
ON CONFLICT DO NOTHING;
